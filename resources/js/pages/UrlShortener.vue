...
import CreateUrlShortener from '@/components/UrlShortener/Create.vue';
import GeneratedLinkUrlShortener from '@/components/UrlShortener/GeneratedLink.vue';
import { ref } from 'vue';

const shortenedUrl = ref('');

const generatedShortenedUrl = (url) => {
